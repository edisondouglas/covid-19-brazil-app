...
import sourceFlagAC from '../../assets/flags/AC.gif';
...
export default function Main() {
    ...
    var imagens = {
        ...
        "PA": require('../../assets/flags/PA.gif'), "PB": require('../../assets/flags/PB.gif'), "PE": require('../../assets/flags/PE.gif'), "PI": require('../../assets/flags/PI.gif'), "PR": require('../../assets/flags/PR.gif'), "RJ": require('../../assets/flags/RJ.gif'), "RN": require('../../assets/flags/RN.gif'), "RO": require('../../assets/flags/RO.gif'), "RR": require('../../assets/flags/RR.gif'), "RS": require('../../assets/flags/RS.gif'), "SC": require('../../assets/flags/SC.gif'), "SE": require('../../assets/flags/SE.gif'), "SP": require('../../assets/flags/SP.gif'), "TO": require('../../assets/flags/TO.gif')
    };
